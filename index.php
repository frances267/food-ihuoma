...
$menu_items = [
    "Jollof Rice;Nigeria" => "$5.99",
    "Fried Fish with Tonnito;Ghana" => "$8.99",
    "Cape Maley Curry;South Africa" => "$5.49",
    "Koshari;Egypt" => "$1.49",
    "Tsuivan;Mongola" => "$3.49",
    "Kektatagine;Morroco" => "$4.99",
    "Kepta Tangine;Morroco" => "$6.99",
];
?>
...
<head>
    ...
    <title>Sweet Emily's African Dishes</title>
    <style>
        body {
...
<body>
    ...
    <h1>Welcome to Sweet Emily's African Dishes!</h1>
